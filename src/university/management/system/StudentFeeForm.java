...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        String branch[] = {"Non Engg Degree", "Computer Science", "Electronics", "Mechanical", "Civil", "IT"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "UPI PAYMENT GATEWAY");
                openPaytmWindow(); // Open Paytm window here
                setVisible(false);
            } catch (Exception e) {
                e.printStackTrace();
            }
